...
class TableViewController: UITableViewController {
    ...
    //ESTA CLASE LA HE CREADO SELECCIONANDO CREAR COCOA Y MARCANDO QUE EXTIENDA DE UITableViewController
    ...
    //DAMOS LA FUNCIONALIDAD DE PODER BORRAR HACIENDO SWIPE HACIA LA IZQ
